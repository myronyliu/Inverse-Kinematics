...
void BallJoint::constrainParams() {
...
std::map<int, float> BallJoint::adjustableParams() const {
...
void BallJoint::buildParamsFromTransforms() {
    AxisSpinRotation axisSpin(_jointRotation);
